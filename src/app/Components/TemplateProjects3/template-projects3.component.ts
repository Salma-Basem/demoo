...
@Component({
  selector: 'app-template-projects3',
  templateUrl: './template-projects3.component.html',
  styleUrls: ['./template-projects3.component.css']
})
export class TemplateProjects3Component {
  language: string = 'en';
