...
@Component({
  selector: 'app-template-projects5',
  templateUrl: './template-projects5.component.html',
  styleUrls: ['./template-projects5.component.css']
})
export class TemplateProjects5Component {
  language: string = 'en';
