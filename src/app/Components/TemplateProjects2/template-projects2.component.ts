...
@Component({
  selector: 'app-template-projects2',
  templateUrl: './template-projects2.component.html',
  styleUrls: ['./template-projects2.component.css']
})
export class TemplateProjects2Component {
